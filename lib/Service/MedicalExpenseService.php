...
class MedicalExpenseService {
    ...
    public function __construct(private MedicalExpenseMapper $mapper) {}
    ...
    public function create(string $userId, array $data): MedicalExpense {
        ...
        $expense->setProvider($data['provider'] ?? null);
    ...
    public function update(int $id, string $userId, array $data): MedicalExpense {
        ...
        if (array_key_exists('provider', $data))  { $expense->setProvider($data['provider']); }
