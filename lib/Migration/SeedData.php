...
/**
 * Reference data shipped with the app. Applied idempotently by SeedRepairStep on
 * every install and upgrade, so adding a year or an item here is enough.
 */
final class SeedData {

    /**
     * Stamped on every item-donation line as fmv_source so a line records which
     * catalog edition priced it. Bump when the values below are refreshed.
     */
    public const CATALOG_VERSION = 'salvation_army:2026.04';

    /** [tax_year, charitable ¢/mi, medical ¢/mi, business ¢/mi] — IRS standard mileage rates. */
